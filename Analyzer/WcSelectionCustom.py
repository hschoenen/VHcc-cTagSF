...
jet_BvsL           = std.vector('double')()  # new: custom tagger BvsL
...
#outputTree.Branch('jet_BvsL'         ,jet_BvsL      )  # new: custom tagger BvsL
...
#        if jetFilterFlags[i] == False: continue
        ...
        #jet_BvsL_List.append(entry.Jet_BvsL[i])  # new
        ...
        #j_BvsL_List.append(entry.Jet_BvsL[i])  # new
...
#                Z_Mass_best[0] = Z_Mass[0]
    ...
    for i, jPt in enumerate(j_Pt_List):
        ...
        #jet_BvsL.push_back(j_BvsL_List[i])  # new
